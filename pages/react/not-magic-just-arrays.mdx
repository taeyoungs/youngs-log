...
<Callout type="info">
  번역 글입니다. - [Original Post](https://medium.com/@ryardley/react-hooks-not-magic-just-arrays-cd4f1857236e)
</Callout>
...
![Initialisation: Two empty arrays, Cursor is 0](/react/not-magic-just-arrays/1.png)
...
![First render: Items written to the arrays as cursor increments.](/react/not-magic-just-arrays/2.png)
...
![Subsequent render: Items read from the arrays as cursor increments](/react/not-magic-just-arrays/3.png)
...
![Setters “remember” their index and set memory according to it.](/react/not-magic-just-arrays/4.png)
...
![Rendering an extra ‘bad’ hook that will be gone next render - 1](/react/not-magic-just-arrays/5.png)
![Rendering an extra ‘bad’ hook that will be gone next render - 2](/react/not-magic-just-arrays/6.png)
...
![By removing the hook between renders we get an error. - 1](/react/not-magic-just-arrays/7.png)
![By removing the hook between renders we get an error. - 2](/react/not-magic-just-arrays/8.png)
