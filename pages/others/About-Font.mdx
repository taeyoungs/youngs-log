...
![폰트를 불러오는 시점에 대한 설명](/others/font/2.png)
...
<Image src="/others/font/4.gif" alt="FOIT과 FOUT" width={700} height={600} />
...
![폰트 preload 예시](/others/font/5.png)
...
![구글 웹폰트로 prealod를 사용할 수 없는 근거](/others/font/6.png)
