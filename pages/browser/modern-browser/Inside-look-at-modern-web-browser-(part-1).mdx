...
<Callout type="info">번역 글입니다. - [Original Post](https://developer.chrome.com/blog/inside-browser-part1/)</Callout>
...
![Figure 1: 4 CPU cores as office workers sitting at each desk handling tasks as they come in](/browser/modern-browser/part1/1.png)
...
![Figure 2: Many GPU cores with wrench suggesting they handle a limited task](/browser/modern-browser/part1/2.png)
...
우리가 컴퓨터나 핸드폰의 애플리케이션을 실행하면 **CPU**와 **GPU**가 애플리케이션에 전원을 공급한다. 일반적으로 애플리케이션은 OS에서 제공하는 메커니즘을 사용하여 **CPU** 및 **GPU**에서 실행된다.

![Figure 3: Three layers of computer architecture. Machine Hardware at the bottom, Operating System in the middle, and Application on top.](/browser/modern-browser/part1/3.png)
...
![Figure 4: Process as a bounding box, threads as abstract fish swimming inside of a process](/browser/modern-browser/part1/4.png)
...
![Figure 5: Diagram of a process using memory space and storing application data](/browser/modern-browser/part1/5.svg)
...
![Figure 6: Diagram of separate processes communicating over IPC](/browser/modern-browser/part1/6.svg)
...
![Figure 7: Different browser architectures in process/thread diagram](/browser/modern-browser/part1/7.png)
...
![Figure 8: Diagram of Chrome’s multi-process architecture. Multiple layers are shown under Renderer Process to represent Chrome running multiple Renderer Processes for each tab.](/browser/modern-browser/part1/8.png)
...
![Figure 9: Different processes pointing to different parts of browser UI](/browser/modern-browser/part1/9.png)
...
![작업 관리자](/browser/modern-browser/part1/10.png)
...
![Figure 10: Diagram showing multiple processes running each tab](/browser/modern-browser/part1/11.png)
...
![Figure 11: Diagram of Chrome’s servicification moving different services into multiple processes and a single browser process](/browser/modern-browser/part1/12.svg)
...
![Figure 12: Diagram of site isolation; multiple renderer processes pointing to iframes within a site](/browser/modern-browser/part1/13.png)
