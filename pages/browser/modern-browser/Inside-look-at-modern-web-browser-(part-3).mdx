...
<Callout type="info">번역 글입니다. - [Original Post](https://developer.chrome.com/blog/inside-browser-part3/)</Callout>
...
![Figure 1: Renderer process with a main thread, worker threads, a compositor thread, and a raster thread inside](/browser/modern-browser/part3/1.png)
...
![Figure 2: The main thread parsing HTML and building a DOM tree](/browser/modern-browser/part3/2.png)
...
![Figure 3: The main thread parsing CSS to add computed style](/browser/modern-browser/part3/3.png)
...
![Figure 4: A person standing in front of a painting, phone line connected to the other person](/browser/modern-browser/part3/4.png)
...
![Figure 5: The main thread going over DOM tree with computed styles and producing layout tree](/browser/modern-browser/part3/5.png)

> Figure 5: The main thread going over DOM tree with computed styles and producing layout tree

<video controls src="/browser/modern-browser/part3/6.mp4"></video>
...
![Figure 7: A person in front of a canvas holding paintbrush, wondering if they should draw a circle first or square first](/browser/modern-browser/part3/7.png)
...
![Figure 8: Page elements appearing in order of an HTML markup, resulting in wrong rendered image because z-index was not taken into account](/browser/modern-browser/part3/8.png)
...
![Figure 9: The main thread walking through layout tree and producing paint records](/browser/modern-browser/part3/9.png)

> Figure 9: The main thread walking through layout tree and producing paint records

### Updating rendering pipeline is costly

<video controls src="/browser/modern-browser/part3/10.mp4"></video>
...
![Figure 11: Animation frames on a timeline](/browser/modern-browser/part3/11.png)
...
![Figure 12: Animation frames on a timeline, but one frame is blocked by JavaScript](/browser/modern-browser/part3/12.png)
...
![Figure 13: Smaller chunks of JavaScript running on a timeline with animation frame](/browser/modern-browser/part3/13.png)
...
<video controls src="/browser/modern-browser/part3/14.mp4"></video>
...
<video controls src="/browser/modern-browser/part3/15.mp4"></video>
...
![Figure 16: The main thread walking through layout tree producing layer tree](/browser/modern-browser/part3/19.png)
...
![Figure 17: Raster threads creating the bitmap of tiles and sending to GPU](/browser/modern-browser/part3/17.png)
...
![Figure 18: Compositor thread creating compositing frame. Frame is sent to the browser process then to GPU](/browser/modern-browser/part3/18.png)
